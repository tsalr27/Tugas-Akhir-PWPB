...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/library.jpeg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: white;">SI-<b>Perpus Grafika</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:5px solid #f5f5f5;">
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: white;"> Copyright &copy; SI-Perpus SMKN 4 Malang <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
